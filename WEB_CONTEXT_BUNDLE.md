...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.118"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-v1",
      "problem_contract_sha256": "b5e4fd313342adc52dfce07512c30c15c06ae46e6ddf100daf95becd2b7c2ee6",
      "problem_id": "problem:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11",
      "route_id": "route:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-source-fidelity-01",
      "graph_id": "graph:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there any group which is not isomorphic to the quotient of a residually finite group by an amenable normal subgroup?"
          },
          "statement_sha256": "5647ba101ae373c06c37cd7f7d1a27a096424ecda7a09403f6725ecd66d83246"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-root",
      "route_id": "route:um-kou-21.118-kourovka-notebook-problem-21.118-5b0e5a11-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.118-a398f66895e8",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.118"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
